use crate::effect_system::{CancellationToken, Channel, SpawnScope};
...
impl Default for OmniInterpreter {
    fn default() -> Self {
        Self::new()
    }
}
...
impl OmniInterpreter {
    ...
    pub fn enable_ffi(&mut self) -> Result<(), crate::security::FfiError> {
...
mod tests {
    ...
    fn test_interpreter_ffi() {
        ...
        interp.enable_ffi().expect("sandbox allocation");
