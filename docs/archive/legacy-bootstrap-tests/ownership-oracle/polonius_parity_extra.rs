...
fn polonius_parity_additional_cases() {
    ...
    let mut f1 = mir::MirFunction::new("drop_then_use", false);
    ...
    let mut f2 = mir::MirFunction::new("field_move_then_use", false);
    ...
    let mut f3 = mir::MirFunction::new("multi_block_move", false);
    ...
    let mut f4 = mir::MirFunction::new("reinit_after_move", false);
